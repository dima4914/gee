...
class PreprocessingEE:
    ...
    def __init__(self, start_date, end_date, limit=10, cloud = 20, palette=['black', 'white']):
        ...
        self.layers = {}#format: layer id in qgis: {'id': unique gee id used in import , 'meta': information, can have properties, 'obj': ee.Object
        self.cloud = cloud
    ...
    def import_e(self,image_name, bands, geometry=None, layer_name='gee_data'):
        ...
        self.subscript_layer(image_name, layer_name, image, info)  # here we merge qgis and gee layer information
        return image
    ...
    def export_e(self, layer_name, scale, max_pixels=1e9, format_='GeoTIFF', geometry=None, verbose=True):
